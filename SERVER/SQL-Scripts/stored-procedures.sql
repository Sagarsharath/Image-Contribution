...
CREATE PROCEDURE IsEmailExists(IN mailId VARCHAR(20), OUT countMail INTEGER)
BEGIN 
...
-- save user data
CREATE PROCEDURE saveUser(IN uname VARCHAR(10),IN umail VARCHAR(30),IN pass VARCHAR(40),In idrole INT(5))
BEGIN 
